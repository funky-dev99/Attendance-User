...
class CassualLeave extends StatefulWidget {
  CassualLeave({Key? key}) : super(key: key);

  @override
  State<CassualLeave> createState() => _CassualLeaveState();
}

class _CassualLeaveState extends State<CassualLeave> {
