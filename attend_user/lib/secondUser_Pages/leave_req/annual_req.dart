...
class _SecAnnuLeaveState extends State<SecAnnuLeave> {
  ...
  String companyName = 'cbs';
  String userId = '12345';
  String userName = 'DD';

  @override
  void initState() {
    fromdateController.text = ""; // set the initial value of the text field
    todateController.text = ""; // set the initial value of the text field
    super.initState();
  }
...
void snackBar(BuildContext context, String text, Color bgColor) {
